...
/*   Updated: 2024/08/26 17:32:11 by JFikents         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << other._formatName() << " copied its software to ";
	std::cout << this->_formatName() << "." << std::endl;
	std::cout << this->_formatName() << " is now a perfect clone of ";
	std::cout << other._formatName() << "." << std::endl;
...
std::string	ClapTrap::_formatName(void) const
{
	std::stringstream	ss;
...
{
	const unsigned int	max_repair = this->_maxHitPoints - this->_hitPoints;
...
void	ClapTrap::_deadMessage(enum ClapTrapActions action) const
{
...
void	ClapTrap::_noEnergyMessage(enum ClapTrapActions action) const
{
